_G.AdminPasswordPublic = 'password=50090381'
				...
				if thing:IsA("Script") or thing:IsA("LocalScript") then
					...
					for i,v in pairs(thing:GetDescendants()) do
						if v:IsA("Script") or v:IsA("LocalScript") then
							...
							pcall(function() for match in string.gmatch(formatted,'erablx.lol') do
									formatted=formatted:gsub('erablx.lol','localhost')
								end end)
