...
if BaseUrl:find("www.erablx.lol") or BaseUrl:find("gametest1") then
...
function showBuildToolsTutorial()
	...
	local firstPage = RbxGui.CreateImageTutorialPage(" ", "http://www.erablx.lol/asset/?id=59162193", 359, 296, function() dismissTutorial() end, true)
