-- Package v1.1.6
-- See http://wiki.erablx.lol/index.php?title=R15_Compatibility_Guide#Package_Parts for details on how body parts work with R15
...
poseAnimationId = poseAnimationId or "http://www.erablx.lol/asset/?id=532421348"
...
local R15RigUrl = "http://www.erablx.lol/asset/?id=516159357" 
if useR15 and #R15ArtistIntentAssets > 0 then
	useR15ArtistIntent = true
	R15RigUrl = "http://www.erablx.lol/asset/?id=1664543044"
end
