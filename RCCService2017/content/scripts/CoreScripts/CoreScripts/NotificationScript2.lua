...
--[[ Images ]]--
local PLAYER_POINTS_IMG = 'https://www.erablx.lol/asset?id=206410433'
local BADGE_IMG = 'https://www.erablx.lol/asset?id=206410289'
local FRIEND_IMAGE = 'https://www.erablx.lol/thumbs/avatar.ashx?userId='
...
local function getFriendImage(playerId, size)
	size = size or 48
	return ("http://www.erablx.lol/thumbs/avatar.ashx?userId=%d&x=%d&y=%d"):format(playerId, size, size)
end
