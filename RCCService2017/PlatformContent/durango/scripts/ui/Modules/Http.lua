--[[
			...
			// Any calls to erablx.lol need to use game:HttpGetAynsc() and game:HttpPostAynsc()
				// use rbxGetAsync() and rbxPostAsync()
			// Any calls to api.erablx.lol should use HttpRbxApiService
...
function Http.PurchaseProductAsync(productId, expectedPrice, expectedSellerId, expectedCurrency)
	...
	-- return http://www.erablx.lol/API/Item.ashx?rqtype=purchase&productID=24805065&expectedCurrency=1&expectedPrice=88&expectedSellerID=1
end
