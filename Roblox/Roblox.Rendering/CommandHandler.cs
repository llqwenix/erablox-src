...
namespace Roblox.Rendering
{
    public static class CommandHandler
    {
		...
		<SOAP-ENV:Envelope xmlns:SOAP-ENV=""http://schemas.xmlsoap.org/soap/envelope/"" 
						   ...
						   xmlns:ns2=""http://erablx.lol/RCCServiceSoap"" 
						   xmlns:ns1=""http://erablx.lol/"" 
						   xmlns:ns3=""http://erablx.lol/RCCServiceSoap12"">
			<SOAP-ENV:Body>
				<ns1:CloseJob>
			...
			await SendSoapRequest(port, "http://erablx.lol/CloseJob", XML);
		}  
		...
		<soap:Envelope xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance""
		   ...
		   xmlns:soap=""http://schemas.xmlsoap.org/soap/envelope/"">
			...
			try
			{
				var res = await SendSoapRequest(port, "http://erablx.lol/OpenJob", XML);
				...
				NSManager.AddNamespace("ns1", "http://erablx.lol/");
