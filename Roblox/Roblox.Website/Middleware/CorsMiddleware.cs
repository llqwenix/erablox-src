...
public class RobloxPlayerCorsMiddleware
{
    ...
    {
        var connectSrc = "'self' https://*.erablx.lol https://erablx.lol https://*.erablx.lol https://erablx.lol wss://*.localhost:90 https://hcaptcha.com https://*.hcaptcha.com https://*.cdn.com";
#if DEBUG
        ...
        return "default-src 'self'; img-src https://erablx.lol https://*.erablx.lol http://erablx.lol https://*.erablx.lol data:; child-src 'self'; script-src https://esm.sh "+scriptSrc+"; frame-src 'self' https://hcaptcha.com https://*.hcaptcha.com https://*.erablx.lol https://erablx.lol https://*.erablx.lol https://erablx.lol http://erablx.lol http://*.erablx.lol; style-src 'unsafe-inline' 'self' https://fonts.googleapis.com https://hcaptcha.com https://*.hcaptcha.com https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css; font-src 'self' fonts.gstatic.com; connect-src "+connectSrc+"; worker-src 'self';";
    }
