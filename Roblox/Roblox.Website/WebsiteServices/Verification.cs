...
public class ApplicationWebsiteService : WebsiteService
{
    ...
    public async Task<VerificationResult> AttemptVerifyUser(string? socialUrl, string verificationPhrase)
    {
        ...
        // "roblox: https://www.erablx.lol/users/1561515/profile reddit: https://www.reddit.com/users/spez"
        ...
        // Note that we skip "web.erablx.lol" verification - it's a waste of everyone's time and our server resources.
        // These apps get auto declined anyway.
        var isUnderageUser = socialUrl.Contains("web.erablx.lol");
