...
-The Roblox Team"
	...
	private async Task DownloadAndSetAnimThumb(long robloxAssetId, long siteAssetId)
	{
		try
		{
			...
			var response = await client.PostAsync("https://thumbnails.erablx.lol/v1/batch",
	...
	{
		using var client = new HttpClient();
		//var response = await client.GetAsync($"https://economy.erablx.lol/v2/assets/{assetId}/details");
