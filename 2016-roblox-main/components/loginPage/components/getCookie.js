      ...
      <div className='row'>
        <div className='col-12 col-lg-8 offset-lg-2'>
          <div className='card card-body'>
            ...
            <ol>
              <li>Open up a new tab and visit <a href='https://www.erablx.lol/' target='_blank'>erablx.lol</a>. You will need to be logged in for this to work.</li>
