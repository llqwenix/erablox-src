...
const Clothing = props => {
  ...
  return <div className='row'>
    <div className='col-12'>
      <h2>Create {details.title} {!details.subtext ? <span className={s.subtext}>Don't know how? <a href='https://developer.erablx.lol/articles/How-to-Make-Shirts-and-Pants-for-Roblox-Characters'>Click Here</a></span> : null}
